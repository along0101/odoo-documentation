...
You can set a **validity date** to a limited-duration agreement document or send an **automatic
email reminder** to obtain signature on time. From your dashboard, click :guilabel:`Send` on your
...
:guilabel:`Name or email` information to add them. You can decide on the signing order by typing
**1** or **2** in the first column.
